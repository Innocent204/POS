...
// Price Mapping Helpers to swap Cost and Selling prices as requested
const mapProduct = (p)=>({
        ...p,
        // Swap: Use the backend's selling price as the "Main Price" (costPrice) in the app
        costPrice: p.sellingPrice || 0,
        sellingPrice: p.costPrice || 0
    });
const mapStock = (s)=>({
        ...s,
        costPrice: s.sellingPrice || 0,
        sellingPrice: s.costPrice || 0
    });
const mapProductRequest = (data)=>({
        ...data,
        // Swap back for persistence: The app's primary price (costPrice) saved as sellingPrice
        sellingPrice: data.costPrice,
        costPrice: data.sellingPrice
    });
const api = {
    auth: {
    ...
    products: {
        getAll: (params)=>apiClient.get('/products', {
                ...
                if (data.success && data.data?.content) {
                    data.data.content = data.data.content.map(mapProduct);
                }
                return data;
            }),
        getById: (id)=>apiClient.get(`/products/${id}`).then((res)=>{
                const data = res.data;
                if (data.success && data.data) {
                    data.data = mapProduct(data.data);
                }
                return data;
            }),
        create: (data)=>apiClient.post('/products', mapProductRequest(data)).then((res)=>{
                const resData = res.data;
                if (resData.success && resData.data) {
                    resData.data = mapProduct(resData.data);
                }
                return resData;
            }),
        update: (id, data)=>apiClient.put(`/products/${id}`, mapProductRequest(data)).then((res)=>{
                const resData = res.data;
                if (resData.success && resData.data) {
                    resData.data = mapProduct(resData.data);
                }
    ...
    stock: {
        getByBranch: (branchId)=>apiClient.get(`/stock/branch/${branchId}`).then((res)=>{
                const data = res.data;
                if (data.success && data.data) {
                    data.data = data.data.map(mapStock);
                }
                return data;
            }),
        getByProduct: (productId)=>apiClient.get(`/stock/product/${productId}`).then((res)=>{
                const data = res.data;
                if (data.success && data.data) {
                    data.data = data.data.map(mapStock);
                }
        ...
        adjust: (data)=>apiClient.post('/stock/adjust', data).then((res)=>{
                const resData = res.data;
                if (resData.success && resData.data) {
                    resData.data = mapStock(resData.data);
                }
                return resData;
            }),
        ...
        getLowStock: ()=>apiClient.get('/stock/low-stock').then((res)=>{
                const data = res.data;
                if (data.success && data.data) {
                    data.data = data.data.map(mapStock);
                }
        ...
        getOutOfStock: ()=>apiClient.get('/stock/out-of-stock').then((res)=>{
                const data = res.data;
                if (data.success && data.data) {
                    data.data = data.data.map(mapStock);
                }
...
function UsersPage() {
    ...
    const fetchUsers = async ()=>{
        try {
            ...
            const [usersRes, branchesRes] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].users.getAll(),
    ...
    const handleCreate = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].users.create(payload);
            if (response.success) {
                toast({
                    title: 'Success',
    ...
    const handleEditSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].users.update(editingUser, payload);
            if (response.success) {
                toast({
                    title: 'Success',
    ...
    const handleDeactivate = async (id)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].users.delete(id);
            if (response.success) {
                toast({
                    title: 'Deactivated',
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                ...
                                                children: [
                                                    ...
                                                    (formData.role === 'CASHIER' || formData.role === 'MANAGER') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "space-y-2",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Label"], {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                            ...
                                            children: loading ? [
                                                ...Array(5)
                                                    ...
                                                    lineNumber: 460,
                                                    columnNumber: 23
                                                }, this)) : filteredUsers.length > 0 ? filteredUsers.map((user)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: user.assignedBranchName || /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: user.lastLogin ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDate"])(user.lastLogin) : 'Never'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/users/page.tsx",
                                                            lineNumber: 493,
                                                            columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: loading ? [
                                    ...Array(3)
                                        ...
                                        lineNumber: 537,
                                        columnNumber: 19
                                    }, this)) : filteredUsers.length > 0 ? filteredUsers.map((user)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__262e2f4b._.js.map