...
// Dynamic imports for heavy libraries to prevent SSR/Turbopack issues
...
function TransfersPage() {
    ...
    const handleReceiveSubmit = async ()=>{
        ...
        try {
            ...
            if (response.success) {
                ...
                try {
                    const destinationStock = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].stock.getByBranch(receivingTransfer.destinationBranchId);
        ...
        try {
            ...
            if (response.success) {
                ...
                if (cancellingTransfer.status === 'IN_TRANSIT' || cancellingTransfer.status === 'PENDING') {
                    try {
                        const stockAdjustments = await Promise.allSettled(cancellingTransfer.items.map((item)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].stock.adjust({
    ...
    const exportToExcel = async ()=>{
        ...
        try {
            const ExcelJS = (await __turbopack_context__.A("[project]/node_modules/exceljs/dist/exceljs.min.js [app-client] (ecmascript, async loader)")).default || await __turbopack_context__.A("[project]/node_modules/exceljs/dist/exceljs.min.js [app-client] (ecmascript, async loader)");
            const { saveAs } = await __turbopack_context__.A("[project]/node_modules/file-saver/dist/FileSaver.min.js [app-client] (ecmascript, async loader)");
...
//# sourceMappingURL=src_7b967197._.js.map