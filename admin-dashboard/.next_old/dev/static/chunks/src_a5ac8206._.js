                    ...
                    try {
                        ...
                        if (res.success && res.data) {
                            ...
                            const uniqueProducts = mappedProducts.filter({
                                "ProductsPage.useEffect.loadBranchProducts.uniqueProducts": (product, index, self)=>index === self.findIndex({
                                        "ProductsPage.useEffect.loadBranchProducts.uniqueProducts": (p)=>p.name.toLowerCase() === product.name.toLowerCase()
                                    }["ProductsPage.useEffect.loadBranchProducts.uniqueProducts"])
                            }["ProductsPage.useEffect.loadBranchProducts.uniqueProducts"]);
...
//# sourceMappingURL=src_a5ac8206._.js.map