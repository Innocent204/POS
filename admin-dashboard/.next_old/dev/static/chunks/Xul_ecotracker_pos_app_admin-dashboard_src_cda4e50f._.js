...
const reportDefinitions = [
    ...
    },
    {
        ...
        description: 'Breakdown of sales performance and tax audits.',
        type: 'Sales',
...
function ReportsPage() {
    ...
    const handleGenerateReport = async (report)=>{
        try {
            ...
            // In a real scenario, this might return a blob (PDF/CSV)
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$Xul$2f$ecotracker_pos_app$2f$admin$2d$dashboard$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_BASE_URL}${report.endpoint}`, {
                method: 'GET',
                headers: {
            ...
            link.href = url;
            link.setAttribute('download', `${report.id}_${new Date().toISOString().split('T')[0]}.pdf`);
            document.body.appendChild(link);
            link.click();
            document.body.removeChild(link);
            toast({
                title: "Report Generated",
                description: `${report.name} has been successfully generated and downloaded.`
            });
        } catch (err) {
...
_s(ReportsPage, "JT08NkuNI90P07hgxs40z/FPOPE=", false, function() {
    return [
...
//# sourceMappingURL=Xul_ecotracker_pos_app_admin-dashboard_src_cda4e50f._.js.map